import { getAugmentedNamespace, selectTranslation, LogManager, asProperty, getSession, handleError, DescribedError, fromConstant$, dynUnavailable, pageScope, getNanoflowArguments$, toFriendlyId, nanoflowEngine, ensure, readUntracked, MxObject, available, unavailable, reactExports, jsxRuntimeExports, classNames, asPluginWidgets } from '../index-C0bqjiJG.js';
import { PageFragment, ExpressionProperty } from '../ScrollContainer-C0iuIrQQ.js';
import { fromObjectProperty$, ActionButton, TextProperty, ActionProperty } from '../ActionButton-CJv0U8vt.js';
import { debounce, Alert, getAriaLabelProps, getValidationAriaProps, FormGroup, TextBox, DerivedUniqueIdProperty, ValidationProperty } from '../TextBox-DmEjxpBn.js';
import { handleDataSourceExecutionError } from '../CsY9Olfe-aLe2hYp_.js';
...
const DS_Feedback_Populate = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "operationId": "UmcRRLfrp1+8szNOFQXOVQ",
      "parameters": [
        {
          "name": "Feedback",
          "value": {
...
const ACT_Feedback_TriggerScreenshotMode = {
  ...
  "instructions": [
    ...
    {
      "type": "commitObjects",
      "operationId": "ImpRzGG0bFyrbJK39JtRfw",
      "inputVar": "Feedback"
    },
    {
      "type": "jump",
...
const ACT_Feedback_UploadImage = {
  ...
  "instructions": [
    ...
    {
      "type": "commitObjects",
      "operationId": "LNmuiXRpv1mTN7MRGT+J+A",
      "inputVar": "Feedback"
    },
    {
      "type": "openForm",
  ...
  "instructions": [
    {
      ...
      "operationId": "6FMn7YFeLFCW7s3FEQkFpA",
      "parameters": [
        {
          "name": "Feedback",
          "value": {
    ...
    },
    {
      ...
      "operationId": "Q8RULKgswFOv3CU+sCLPiQ",
      "parameters": [
        {
          "name": "Feedback",
          "value": {
...
const region$Main = (historyId) => /* @__PURE__ */ React.createElement(PageFragment, { renderKey: historyId }, [
  /* @__PURE__ */ React.createElement(
    $Div,
    {
      key: "p28.FeedbackModule.ShareFeedback.layoutGrid1",
      ...
      content: [
        /* @__PURE__ */ React.createElement(
          $Div,
          {
            key: "p28.FeedbackModule.ShareFeedback.layoutGrid1$row0",
            ...
            content: [
              /* @__PURE__ */ React.createElement(
                $Div,
                {
                  key: "p28.FeedbackModule.ShareFeedback.layoutGrid1$row0$column0",
                  ...
                  content: [
                    /* @__PURE__ */ React.createElement(
                      $DataView,
                      {
                        key: "p28.FeedbackModule.ShareFeedback.dataView5",
                        ...
                        body: [
                          /* @__PURE__ */ React.createElement(
                            $Container,
                            {
                              key: "p28.FeedbackModule.ShareFeedback.container5",
                              ...
                              content: [
                                /* @__PURE__ */ React.createElement(
                                  $Text,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.text1",
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $FormGroup,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.feedback_subject$formGroup",
                                    ...
                                    control: [
                                      /* @__PURE__ */ React.createElement(
                                        $TextBox,
                                        {
                                          key: "p28.FeedbackModule.ShareFeedback.feedback_subject",
                                          ...
                                          inputValue: AttributeProperty({
                                            ...
                                            "attribute": "Subject",
                                            "onChange": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p28.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require$$1$1.OCH_Feedback_SaveToLocalStorage }, "disabledDuringExecution": false },
                                            "isList": false,
                                            "validation": null,
                                            "formatting": {}
                                          }),
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $FormGroup,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.textArea2$formGroup",
                                    ...
                                    control: [
                                      /* @__PURE__ */ React.createElement(
                                        $TextArea,
                                        {
                                          key: "p28.FeedbackModule.ShareFeedback.textArea2",
                          ...
                          /* @__PURE__ */ React.createElement(
                            $Container,
                            {
                              key: "p28.FeedbackModule.ShareFeedback.container4",
                              ...
                              content: [
                                /* @__PURE__ */ React.createElement(
                                  $Label,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.label1",
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $Text,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.text2",
                          ...
                          /* @__PURE__ */ React.createElement(
                            $Container,
                            {
                              key: "p28.FeedbackModule.ShareFeedback.container2",
                              ...
                              content: [
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.actionButton4",
                                    ...
                                    action: ActionProperty({
                                      "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p28.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require$$2.ACT_Feedback_TriggerScreenshotMode }, "disabledDuringExecution": true },
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.actionButton5",
                                    ...
                                    action: ActionProperty({
                                      "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p28.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require$$3.ACT_Feedback_UploadImage }, "disabledDuringExecution": true },
                                      "abortOnServerValidation": true
                                    })
                                  }
                                )
                          ...
                          /* @__PURE__ */ React.createElement(
                            ...
                            {
                              key: "p28.FeedbackModule.ShareFeedback.container6$visibility",
                              ...
                              contents: [
                                /* @__PURE__ */ React.createElement(
                                  $Container,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.container6",
                                    ...
                                    content: [
                                      /* @__PURE__ */ React.createElement(
                                        $Container,
                                        {
                                          key: "p28.FeedbackModule.ShareFeedback.container7",
                                          ...
                                          content: [
                                            /* @__PURE__ */ React.createElement(
                                              $ActionButton,
                                              {
                                                key: "p28.FeedbackModule.ShareFeedback.actionButton1",
                                                ...
                                                action: ActionProperty({
                                                  "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p28.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require$$4.ACT_Feedback_ClearImage }, "disabledDuringExecution": true },
                                                  "abortOnServerValidation": true
                                                })
                                              }
                                            ),
                                            /* @__PURE__ */ React.createElement(
                                              $Image,
                                              {
                                                key: "p28.FeedbackModule.ShareFeedback.image1",
                          ...
                          /* @__PURE__ */ React.createElement(
                            $ConditionalVisibilityWrapper,
                            {
                              key: "p28.FeedbackModule.ShareFeedback.textBox1$formGroup$visibility",
                              ...
                              contents: [
                                /* @__PURE__ */ React.createElement(
                                  $FormGroup,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.textBox1$formGroup",
                                    ...
                                    control: [
                                      /* @__PURE__ */ React.createElement(
                                        $TextBox,
                                        {
                                          key: "p28.FeedbackModule.ShareFeedback.textBox1",
                          ...
                          /* @__PURE__ */ React.createElement(
                            $Container,
                            {
                              key: "p28.FeedbackModule.ShareFeedback.container3",
                              ...
                              content: [
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.feedback_cancel",
                                ...
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.feedback_clear",
                                    ...
                                    icon: void 0,
                                    action: ActionProperty({
                                      "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p28.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require$$5.ACT_Feedback_ClearForm }, "disabledDuringExecution": true },
                                      "abortOnServerValidation": true
                                    })
                                  }
                                ),
                                /* @__PURE__ */ React.createElement(
                                  $ActionButton,
                                  {
                                    key: "p28.FeedbackModule.ShareFeedback.feedback_submit",
                                    ...
                                    icon: void 0,
                                    action: ActionProperty({
                                      "action": { "type": "callNanoflow", "argMap": { "Feedback": { "widget": "p28.FeedbackModule.ShareFeedback.dataView5", "source": "object" } }, "config": { "nanoflow": () => require$$6.ACT_SubmitFeedback }, "disabledDuringExecution": true },
                                      "abortOnServerValidation": true
                                    })
                                  }
                                )
...
const classes = "";
const cancelChangesOperationId = "cS837hDkEF+kDmgntlp69g";
const style = {};
const content = {
  ...content$1,
